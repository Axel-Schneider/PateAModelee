...
client.on('message', message => {
    ...
    try{
        ...
        console.warn(`La commande : '${command}' a été utilisé par ${message.member.displayName}\n avec les argument : "${args.slice(0).join(" ")}"`);
    }catch(error)
    {
